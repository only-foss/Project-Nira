...
<table>
  <tr>
    <td align="center" width="50%">
      <img src="tests/results/nira_01_timeseries.png" width="100%" alt="Time Series"/><br/>
      <sub><b>01 — Time Series</b><br/>CH1, CH4 &amp; differential signal over time</sub>
    </td>
    <td align="center" width="50%">
      <img src="tests/results/nira_02_comparison.png" width="100%" alt="Comparison"/><br/>
      <sub><b>02 — Comparison</b><br/>Mean ± σ bar chart + box plot</sub>
    </td>
  </tr>
  <tr>
    <td align="center" width="50%">
      <img src="tests/results/nira_03_histogram.png" width="100%" alt="Histogram"/><br/>
      <sub><b>03 — Distribution</b><br/>Histogram + Gaussian fits + detection threshold</sub>
    </td>
    <td align="center" width="50%">
      <img src="tests/results/nira_04_scatter.png" width="100%" alt="Scatter"/><br/>
      <sub><b>04 — Scatter</b><br/>CH1 vs CH4 — directional shift between conditions</sub>
    </td>
  </tr>
</table>
